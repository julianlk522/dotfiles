...
require('lazy').setup({
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Highlight references of word under cursor when it rests there
          ...
          if client and client.supports_method(vim.lsp.protocol.Methods.textDocument_documentHighlight) then
            ...
            -- Clear LSP highlights on buffer close
      ...
      require('mason-lspconfig').setup {
        handlers = {
          function(server_name)
            ...
            -- Explicit LSP feature overrides
    ...
    config = function()
      ...
      cmp.setup {
        ...
        sources = {
          {
            name = 'lazydev',
            -- Group index to 0 to skip loading LuaLS completions as lazydev recommends it
            group_index = 0,
          },
          { name = 'nvim_lsp' },
          { name = 'luasnip' },
  ...
  { -- Other independent plugins/modules
